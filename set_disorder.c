...
/*   Updated: 2026/05/25 22:07:54 by wezhou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double	set_disorder(t_stack *a_stack)
{
	...
	node_i = a_stack -> top;
	node_j = node_i -> next;
	return (compute_disorder(a_stack, node_i, node_j));
}

double	compute_disorder(t_stack *a_stack, t_node *node_i, t_node *node_j)
{
	size_t	i;
	size_t	j;
	size_t	mistake;
